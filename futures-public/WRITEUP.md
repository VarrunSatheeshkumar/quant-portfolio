...
- Decision: preserved as unresolved. The gross result and its decomposition stand; "+0.93 % net" is withdrawn; the result carries the label given in the halt-rule record below. The result is labelled survivor-conditioned here. Net alpha with weekly costs entered into the series has not been computed, and delisted contracts have not been recovered.
