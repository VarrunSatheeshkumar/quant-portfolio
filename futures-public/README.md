...
- Read the [strategy table](WRITEUP.md#the-three-signals), then check [one C18 week](WRITEUP.md#worked-example-constructing-one-c18-week) from funding ranks to its return and cost proxy.
